...
\paragraph{Question 4.}
    Pour appliquer l'algorithme \texttt{APriori}, il est nécessaire d'appliquer le filtre non supervisé \texttt{Discretize} sur les attributs. \\
    
    Le principe de discrétisation consiste à remplacer des relations portant sur des fonctions continues, dérivables ou autres, par un nombre fini de relations algébriques portant sur les valeurs prises par ces fonctions en un nombre fini de points de leur ensemble de définition.\\
